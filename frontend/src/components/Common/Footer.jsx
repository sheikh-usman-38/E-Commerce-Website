   ...
   <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
    <div>
        ...
        <p className='text-gray-500 mb-4'>
            Be the first to hear bout new products, exclusive events, and online offers.
        </p>
        <p className='font-medium text-sm text-gray-600 mb-6'> Sign up and get 10% off your first order.</p>
            ...
            <form className='flex' >
                ...
                className='p-3 w-full text-sm border-t
                 border-l border-b border-gray-300 rounded-l-md focus:outline-none
